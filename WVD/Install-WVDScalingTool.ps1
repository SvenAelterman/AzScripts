...
if ($UseUsEduLogicApp) {
    ...
    # TODO: Introduce new variable to account for host pool resource group name different from the logic app's
    $HostpoolParams.ResourceGroupName = $AzAAResourceGroupName
